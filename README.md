...
```bash
git clone nostr://npub1x677kgulh6lqaa8e658f9ts4s0x692wgrhcptw535877wfkuwnsqztaquc/relay.ngit.dev/microfips
git clone https://relay.ngit.dev/npub1x677kgulh6lqaa8e658f9ts4s0x692wgrhcptw535877wfkuwnsqztaquc/microfips.git
git clone https://gitnostr.com/npub1x677kgulh6lqaa8e658f9ts4s0x692wgrhcptw535877wfkuwnsqztaquc/microfips.git
```

- **Browse / open PRs:** https://gitworkshop.dev/npub1xh6njjxpze2vwvn0d863dmrxpll0ds04k38t0wqrg5fcr6nf3ursk3xqw3/relay.ngit.dev/microfips
...
- **Announcement (source of truth for the URLs above):** kind `30617`,
  `d=microfips`, by `36bdeb239fbebe0ef4f9d50e92ae1583cda2a9c81df015ba91a1fde726dc74e0`, relays: `wss://relay.ngit.dev wss://gitnostr.com`
...
```bash
nak req -k 1063 -t "A=30617:36bdeb239fbebe0ef4f9d50e92ae1583cda2a9c81df015ba91a1fde726dc74e0:microfips" wss://relay.ngit.dev   # url + x tags
```
...
`b16e808e2d5387a5306a8a89f20d5f9ada7858e34113a390554540133e80897b` (created 1788179564). Doc not be hand-edited: re-run the generator.*
